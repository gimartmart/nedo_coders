...
__name__ = "Icecream"
__version__ = "2.2.0"  # major.minor.patch
__pycord_version__ = "2.3.3.dev46+gb6ebeda7"
__version_date__ = "14.01.2023"  # d.m.y (may be unaccurate)
...
class Icecream(commands.Bot):
    def __init__(self, *args, **kwargs):
        ...
        events = [
            "button_click",
            "message_delete",
            "raw_message_delete",  # saved_messages
            "bulk_message_delete",
            "message_edit",
    ...
    async def on_ready(self) -> None:
        ...
        await self.change_presence(activity=None)  # discord.Game(f"SAKANA"))
